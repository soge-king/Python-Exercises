# -*- coding: utf-8 -*-
"""
Created on Tue Feb  6 22:20:39 2024
...
def evaluate_calculation():
    ...
    try:
        ...
        text_result.delete(1.0, "end")  # Make sure this is "END" not "end"
        text_result.insert(1.0, calculation)  # Corrected the typo here
        
    except:  # Catch exceptions and optionally print or log them
        clear_field()
        text_result.insert(1.0, "error")  # Corrected the typo here
...
btn_mult = tk.Button(root, text="*", command=lambda: add_to_calculation("*"), width=5, font=("Arial", 24))
...
btn_eq = tk.Button(root, text="=", command=evaluate_calculation, width=11, font=("Arial", 24))
